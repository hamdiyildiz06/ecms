                ...
                <table class="table table-striped">
                    ...
                    @foreach($data['slider'] as $slider)
                        <tr id="item-{{$slider->id}}">
                            ...
                            <td class="sortable" width="100">@php echo ($slider->slider_file != "") ? "<img width='100' src='/images/sliders/".$slider->slider_file."' alt=''>" : null @endphp</td>
                            <td>{{$slider['slider_title']}}</td>
                            <td width="5"><a href="{{route('slider.edit',$slider->id)}}"><i class="fa fa-pencil-square"></i></a></td>
                            <td width="5"><a href="javascript:void(0)"><i id="{{$slider->id}}" class="fa fa-trash-o"></i></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                    </thead>
